...
const bannerData = [
  {
    title: "Nước Mắm",
    subtitle: "Đậm đà hương vị Việt",
    description:
      "Trải nghiệm vị ngon nguyên chất, tinh túy từ biển cả, phù hợp cho mọi bữa ăn gia đình",
    discount: "Giảm đến 20%",
    from: 120000,
    sale: "Sản phẩm bán chạy",
    image: bannerImgOne,
    buttonText: "Mua Ngay",
  },
  {
    ...
    description: "100% mật ong tự nhiên, bổ dưỡng, tăng cường sức đề kháng",
  ...
  },
  {
    ...
    subtitle: "Tinh hoa ẩm thực mùa trăng",
    description: "Bánh Trung Thu thơm ngon, đa dạng hương vị, quà tặng ý nghĩa",
    discount: "Freeship",
    from: 350000,
    sale: "Khuyến mãi lễ hội",
    image: bannerImgThree,
    buttonText: "Đặt Bánh Trung Thu",
  },
];
